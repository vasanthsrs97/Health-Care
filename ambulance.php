...
<head>
  ...
  <meta name="description" content="Display Ambulance numbers">
...
<body>
<section class="menu cid-qyMbzrT5JC" once="menu" id="menu1-z" data-rv-view="11934">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="index.html">
                         <img src="assets/images/medical-512x512.png" alt="Mobirise" title="" media-simple="true" style="height: 4.4rem;">
                    </a>
                </span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                ...
                </li><li class="nav-item"><a class="nav-link link text-white display-4" href="ambulance.html"><span class="mbri-delivery mbr-iconfont mbr-iconfont-btn"></span>
...
<section class="engine"><a href="https://mobirise.co/g">how to create a website for free</a></section><section class="section-table cid-qyMK9tqWUB" id="table1-17" data-rv-view="11936">

  
  
  <div class="container container-table">
      <h2 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">
          Ambulance Numbers</h2>
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
            <thead>
              ...
              <th class="head-item mbr-fonts-style display-7">AMBULANCE</th><th class="head-item mbr-fonts-style display-7">
                      PHONE NUMBER</th></tr>
            </thead>
        ...
        if($conn->connect_error)
{
	die("Connection Failed". $conn->connect_error);
              ...
              $sql = "SELECT name,phone FROM ambulance";
...
<section once="" class="cid-qyMPFox0F1" id="footer7-1g" data-rv-view="12155">
